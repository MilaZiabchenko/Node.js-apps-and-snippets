...
if (fs.existsSync(DIR_1)) {
  ...
  console.log(`Empty folder 'accounts' renamed to 'library'`);
} else if (fs.existsSync(DIR_2)) {
  fs.renameSync(DIR_2, DIR_1);

  console.log(`Empty folder 'library' renamed to 'accounts'`);
}
...
if (fs.existsSync(DIR_3)) {
  ...
  console.log(`Folder with files 'markdown' renamed to 'md'`);
