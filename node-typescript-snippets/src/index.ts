...
type PersonHasQuality = ReturnType<
  typeof getObjectProperty<HumanInfo, 'isCool'>
>;
...
type PersonQualitiesInfo = Partial<
  Record<'isSmart' | 'isCourageous' | 'isProfessional', PersonHasQuality>
>;
